...
export function ProfileSignalCard({
  ...
  function onPointerMove(event: PointerEvent<HTMLDivElement>) {
    ...
    card.style.setProperty("--profile-tilt-x", `${y * -5}deg`);
    card.style.setProperty("--profile-tilt-y", `${x * 6}deg`);
  ...
  return (
    <section
      className="profile-signal-card overflow-hidden rounded-panel border border-line bg-panel-solid/90"
    ...
    >
      ...
      <div className="p-5">
        <div className="profile-signal-frame relative overflow-hidden rounded-[0.7rem] border border-line bg-bg-navy/80 p-3">
          <div className="profile-radar" aria-hidden="true" />
          <div className="relative overflow-hidden rounded-control border border-line bg-bg-void">
            {hasPhoto ? (
              <Image
        ...
        <div className="mt-5 grid grid-cols-3 gap-2" role="tablist" aria-label="Profile signal modes">
          {modes.map((item) => (
            <button
        ...
        <div className="mt-4 rounded-control border border-line bg-bg-navy/55 p-4" role="tabpanel">
          ...
          <div className="profile-waveform mt-4" aria-hidden="true">
